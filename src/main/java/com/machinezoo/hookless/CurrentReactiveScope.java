 ...
 */
@DraftDocs("reactive blocking link, reactive freezes link, reactive pins link, reactive computation link")
public class CurrentReactiveScope {
	...
	/**
	 * Returns {@code true} if the current reactive computation is reactively blocking.
	 ...
	 * 
	 * @param <T> type of value returned by the {@code supplier}
	 * @param key identifier for particular frozen value, which implements {@link Object#equals(Object)} and {@link Object#hashCode()}
	 * @param supplier value supplier to evaluate
	 ...
	 * On first call with given {@code key}, returns result of evaluating the {@code supplier}.
	 * On subsequent calls within the same sequence of blocking reactive computations (pin lifetime),
	 ...
	 * 
	 * @param <T> type of value returned by the {@code supplier}
	 * @param key identifier for particular pinned value, which implements {@link Object#equals(Object)} and {@link Object#hashCode()}
	 * @param supplier value supplier to evaluate
