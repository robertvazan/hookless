 ...
 */
public interface ReactiveData extends ReactiveNode {
	/*
	 ...
	 */
	Collection<ReactiveComputation> subscribers();
	/*
	 ...
	 */
	void subscribe(ReactiveComputation subscriber, long iteration, ReactiveVersion version);
	/*
	 * Redundant unsubscription is ignored, because subscribers can be removed when the data changes.
	 */
	void unsubscribe(ReactiveComputation subscriber);
	/*
